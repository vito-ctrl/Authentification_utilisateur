                ...
                <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
                  ...
                  <form className="max-w-md md:ml-auto w-full" onSubmit={Handelsubmit}>
                    ...
                    <div className="space-y-4">
                        <div>
                            <input name="fullName" type="fullName" className="bg-gray-900 w-full text-sm text-gray-100 px-4 py-3.5 rounded-md focus:bg-transparent" placeholder="Full Name" onChange={HandleChange} required/>
                        </div>
                        <div>
                        ...
                        <div>
                            <input name="password" type="password" autoComplete="password" className="bg-gray-900 w-full text-sm text-gray-100 px-4 py-3.5 rounded-md focus:bg-transparent" placeholder="Password" onChange={HandleChange} required/>
                        </div>
                    </div>
